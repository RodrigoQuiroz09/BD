...
INSERT INTO `productos` VALUES ('6512023951',5,2),('7123569841',3,1),('7201236571',3,2),('7202356412',4,1),('7411125230',4,2),('7486974200',5,7),('7552320151',4,5);
...
CREATE TABLE `transaccion` (
  ...
  KEY `fk_TRANSACCION_USUARIO1_idx` (`Correo_Cliente`),
  CONSTRAINT `fk_TRANSACCION_USUARIO1` FOREIGN KEY (`Correo_Cliente`) REFERENCES `usuario` (`correo_electronico`)
...
INSERT INTO `transaccion` VALUES (3,'andres@gmail.com','2020-06-02 02:37:44','Visa',605.00),(4,'andres@gmail.com','2020-06-02 02:39:22','Visa',1694.00),(5,'andres@gmail.com','2020-06-02 02:44:11','Visa',2015.00);
...
INSERT INTO `usuario` VALUES ('andres@gmail.com','Andres','Barragan','123456','1601 Willow Rd. 1','03265','3216549870','N'),('juan@gmail.com','Juan','Pere<','123456','a. 2','01265','3216543212','N');
...
-- Dump completed on 2020-06-02  2:46:17
